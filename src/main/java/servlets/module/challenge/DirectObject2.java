...
/**
 * Insecure Direct Object Reference Challenge Two Does not use user specific key
...
public class DirectObject2 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("i18n.servlets.challenges.directObject.directObjectRef2",
				locale);
		...
		if (Validate.validateSession(ses)) {
			...
			try {
				...
				PreparedStatement prepstmt = conn
						.prepareStatement("SELECT userName, privateMessage FROM users WHERE userId = ?");
